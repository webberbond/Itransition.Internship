...
namespace Itask6.Controllers
{
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Initial([FromBody] FakerOptions faker)
        {
            ...
            {
                return faker != null
                    ? Ok(GenerateData(new FakerOptions(faker.length, faker.selectedCountry, faker.error, faker.seed)).ToList())
                    : BadRequest();
            }
            catch
            {
        ...
        {
            User user = fakerNums.Random.Number(2) switch
            {
                0 => faker.Generate("default"),
                1 => faker.Generate("First"),
                2 => faker.Generate("Second"),
                _ => faker.Generate("default"),
            };
            return user;
        }
